...
header = ['id', 'itemTime', 'trial#', 'kind','option','trainingMessage','color','scenario', 'qud', 'value','askedQuestion','bet', 'sentExpression', 'RT', 'language', 'comments', 'engagement', 'difficulty']
